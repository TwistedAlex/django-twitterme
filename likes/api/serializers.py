...
class BaseLikeSerializerForCreateAndCancel(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        # following logic is similar to if not model_class.objects.filter(
        # id=data['object_id']).exists():
        # if change filter to "get", 500 error will be raised rather than 4xx
